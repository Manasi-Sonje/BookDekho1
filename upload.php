...
<td>Title</td>
<td>
<input type=text name=title class="login__input"><?php echo $err4; ?></td>
</tr>
<tr>
<td>Update</td>
<td>
<input id="date" type="date" class="login__input"  name=date><?php echo $err3; ?></td>
</tr>
<tr>
<td>Category</td>
<td>
...
<td>Publication</td>
<td>
<input type=text class="login__input" name=pub><?php echo $err9; ?></td>
</tr>
<tr>
<td>Author</td>
<td>
<input type=text class="login__input" name=aut><?php echo $err8; ?></td>
</tr>
<tr>
...
<tr>
<td>
<input type=hidden class="login__input" name=sta value="Available"></td>
</tr>
<tr>
<td>Cover Page</td>
<td>
...
<input type="checkbox" name="quality[]" value="No missing Pages" >No missing Pages<br>
<input type="checkbox" name="quality[]" value="No torn Pages" >No torn Pages<br>
<input type="checkbox" name="quality[]" value="No Writing on Pages" >No Writing on Pages<br>
<input type="checkbox" name="quality[]" value="Latest edition" >Latest edition<br>
</td>
</tr>
...
//     }
echo $chk;
 $sql="insert into upload values('$_POST[uno]','$_SESSION[userid]','$_POST[title]','$_POST[date]','$_POST[cat]','$_POST[lang]','$_POST[edi]','$_POST[pub]','$_POST[aut]','$_POST[org]','$_POST[sel]','$_POST[bookimg]','$_POST[sta]','$_POST[indeximg]','$_POST[indeximg1]','$_POST[middleimg]','$_POST[pages]','$chk')";
...
// $sql = "INSERT INTO upload (Uploadno,Userid,Title) VALUES ('$_POST[uno]','$_SESSION[userid]','$_POST[title]')";
mysql_query($sql,$cn);
