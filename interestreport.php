...
if($_POST['sbm']=="Display")
{
    ...
    $sql= "select distinct interest.Interestno,interest.Interestdate,interest.Userid,interest.Upuserid,interest.deal,upload.Title from interest,upload,user where (user.Userid='$uid') AND (interest.Userid='$uid') AND (upload.Uploadno=interest.Uploadno)";
